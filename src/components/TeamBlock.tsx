    ...
    return (
        <div className={styles.team}>
            <div className={styles.team__member}>
                ...
                <Image src="/persons/person-1.png" alt="CEO" layout="fill" objectFit="cover" quality={100} className={styles.team__image}/>
            </div>
            <div className={styles.team__member}>
                <div className={styles.team__name}>Дарья<br/>Огорельцева</div>
                <div className={styles.team__position}>Операционный директор</div>
                <Image src="/persons/person-2.png" alt="COO" layout="fill" objectFit="cover" quality={100} className={styles.team__image}/>
            </div>
            <div className={styles.team__member}>
                ...
                <Image src="/persons/person-3.png" alt="Director" layout="fill" objectFit="cover" quality={100} className={styles.team__image}/>
            </div>
            <div className={styles.team__member}>
                <div className={styles.team__name}>Александр<br/>Артеев</div>
                <div className={styles.team__position}>Оператор-постановщик</div>
                <Image src="/persons/person-4.png" alt="Operator" layout="fill" objectFit="cover" quality={100} className={styles.team__image}/>
            </div>
            <div className={styles.team__member}>
                ...
                <Image src="/persons/person-who.png" alt="Who's next?" layout="fill" objectFit="cover" quality={100} className={styles.team__image}/>
            </div>
        </div>
    )
}