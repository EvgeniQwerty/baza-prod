...
export default function Projects() {
  return (
    <main className={styles.main}>
      ...
      <Project
        vimeoLink={"https://player.vimeo.com/video/121429401"}
        name={"Псих"}
        org={"Бренд одежды"}
        type={"Fashion-ролик"}
        year={"2023"}
        img1={"/projects/psycho/1.png"}
        img2={"/projects/psycho/2.png"}
        img3={"/projects/psycho/3.png"}
        img4={"/projects/psycho/4.png"}
        backstageVimeoLink={"https://player.vimeo.com/video/121429401"}
