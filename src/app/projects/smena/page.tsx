...
export default function ProjectPage() {
  return (
    <main className={styles.main}>
      ...
      <Project
        vimeoLink={"https://player.vimeo.com/video/1040811042?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479"}
        name={"Первая работа"}
        org={"Кинотеатр Смена"}
        type={"HR-видео"}
        year={"2023"}
        ...
        backstageVimeoLink={"https://player.vimeo.com/video/1040811042?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479"}
