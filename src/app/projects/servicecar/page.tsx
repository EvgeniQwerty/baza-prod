...
export default function ProjectPage() {
  return (
    <main className={styles.main}>
      ...
      <Project 
      vimeoLink={"https://player.vimeo.com/video/1040812485?title=0&amp;byline=0&amp;portrait=0&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479"} 
      name={"Servicecar"} 
      org={"Servicecar"} 
      type={"Реклама на ТВ"} 
      year={"2023"} 
      ...
      backstageVimeoLink={"https://player.vimeo.com/video/1040812485?title=0&amp;byline=0&amp;portrait=0&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479"} 
